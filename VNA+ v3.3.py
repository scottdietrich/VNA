...
Version: 3.3 - Logging Update (January 2026)
...
class VNAMeasurementApp:
    ...
    def _get_trace_y_data(self, trace_data, mode, apply_normalization=True):
        ...
        Args:
            ...
            mode: Display mode (Magnitude, Phase, Real, Imaginary, Conductivity)
        ...
        if apply_normalization and self.normalize_at_v.get():
...
def main():
    """Main entry point."""
    print("=" * 60)
    print("VNA FMR Measurement System v3.3")
