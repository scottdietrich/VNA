...
def main():
    """Main entry point."""
    print("=" * 60)
    print("VNA FMR Measurement System v3.7")
    ...
    print("- SVD background removal and reference map subtraction")
    print("- Time-domain gating passthrough from S2VNA")
    print("- Gate voltage normalization for gate sweeps/steps")
    print("- B-field normalization for field sweeps/steps")
    print("- BK 9132B / Keithley 2400/2450 SMU support")
